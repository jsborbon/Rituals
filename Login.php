...
<form class="login" name="login">
    <ul>
        ...
        <br>
        <li>Contraseña:</li>
        <li><input name="password" type="password" id="password" value="" size="20" /></li>
        <button class="eyePassword" id="showPassword" type="button" onclick="mostrarContrasena()"><i class="fas fa-eye"></i></button>
        <button class="eyePassword" id="hidePassword" type="button" onclick="mostrarContrasena()" style="display: none;"><i class="fas fa-eye-slash"></i></button>
        <br>
